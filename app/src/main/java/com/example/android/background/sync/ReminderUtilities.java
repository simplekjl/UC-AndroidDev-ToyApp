...
public class ReminderUtilities {
    ...
    private static int REMINDER_INTERVAL_MNUTES = 1;
    private static int REMINDER_INTERVAL_SECONDS = (int) (TimeUnit.MINUTES.toSeconds(REMINDER_INTERVAL_MNUTES));
    private static int SYNC_FLEXTIME_SECONDS = REMINDER_INTERVAL_SECONDS;
    private static String REMINDER_JOB_TAG = "hydration-reminder-tag";
